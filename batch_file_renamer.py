...
### Create a log file for each rename task ran?
...
### Build a list of files and edit details using a log file (generated by this script) for the purpose of reverting the renames made in that log.
...
def getRenameRevertFilesAndEditDetails(log_file):
    ...
    edit_details = {
        ...
        LINKED_FILES      : [] ## TODO: Test with out any linked files
    }
...
def updateLogFile(edit_details):
    ...
    ## TODO: Add preset used to log file.
